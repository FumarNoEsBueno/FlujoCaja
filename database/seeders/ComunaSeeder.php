...
class ComunaSeeder extends Seeder
{
    ...
    {
        // Indexamos las regiones por nombre para hacer lookups eficientes
        $regiones = Region::all()->keyBy('regi_nombre');
        ...
        $comunasPorRegion = [
            ...
            'Región Metropolitana de Santiago' => [
                ...
                'Lonquén', 'Macul', 'Maipú', 'María Pinto', 'Melipilla',
                'Miraflores', 'Ñuñoa', 'Padre Hurtado', 'Paine', 'Pedro Aguirre Cerda',
            ...
            "Región del Libertador General Bernardo O'Higgins" => [
                ...
                'San Fernando', 'San Francisco de Mostazal', 'San Vicente',
                'Santa Cruz',
            ],
            'Región del Maule' => [
                'Cauquenes', 'Chanco', 'Colbún', 'Constitución', 'Curepto',
                'Curicó', 'Empedrado', 'Linares', 'Longaví', 'Maule',
                'Molina', 'Parral', 'Pelarco', 'Pelluhue', 'Pencahue',
            ...
            'Región del Biobío' => [
                'Alto Biobío', 'Antuco', 'Arauco', 'Cañete', 'Concepción',
                'Contulmo', 'Coronel', 'Curanilahue', 'Florida', 'Hualpén',
                'Hualqui', 'Laja', 'Lebu', 'Los Álamos', 'Los Ángeles',
                'Lota', 'Mulchén', 'Nacimiento', 'Negrete', 'Penco',
                'Quilaco', 'Quilleco', 'San Pedro de la Paz', 'San Rosendo',
                'Santa Bárbara', 'Santa Juana', 'Talcahuano', 'Tirúa',
                'Tomé', 'Tucapel', 'Yumbel',
            ],
            ...
            'Región de Aysén del General Carlos Ibáñez del Campo' => [
                'Aysén', 'Chile Chico', 'Cisnes', 'Cochrane', 'Coihaique',
        ...
        foreach ($comunasPorRegion as $regionNombre => $comunas) {
            $region = $regiones->get($regionNombre);
