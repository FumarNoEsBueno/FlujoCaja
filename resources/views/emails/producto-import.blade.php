...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header {
            background: {{ count($errores) > 0 ? '#ef4444' : '#22c55e' }};
            padding: 28px 32px;
        }
        ...
        .nota p { font-size: 13px; line-height: 1.5; }
        .nota.error p { color: #92400e; }
        .nota.success p { color: #166534; }
        .footer {
            padding: 20px 32px;
            background: #fafafa;
...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <div class="header">
                <div class="header-icon">{{ count($errores) > 0 ? '⚠️' : '✅' }}</div>
                <h1>{{ count($errores) > 0 ? 'Importación con errores' : 'Importación exitosa' }}</h1>
